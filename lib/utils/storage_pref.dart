...
abstract final class Pref {
  ...
  static double get diagonalRenderAngleOffset => ((_setting.get(
    SettingBoxKey.diagonalRenderAngleOffset,
    defaultValue: 0.0,
  ) as num).clamp(-45.0, 45.0).toDouble());

  static double get diagonalRenderScale => ((_setting.get(
    SettingBoxKey.diagonalRenderScale,
    defaultValue: 15.0,
  ) as num).clamp(0.0, 100.0).toDouble());

  static double get diagonalDanmakuVerticalOffset => ((_setting.get(
    SettingBoxKey.diagonalDanmakuVerticalOffset,
    defaultValue: 0.5,
  ) as num).clamp(0.0, 1.0).toDouble());
